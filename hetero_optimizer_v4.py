...
def get_worker_assignments(phase, n_workers):
    ...
    Phase 1 (explore):  A=5, B=2, C=1, E=1, G=3, H=1, F=1 = 14
    Phase 2 (exploit):  A=6, B=1, C=1, E=1, G=3, H=1, F=1 = 14
    Phase 3 (polish):   A=7, C=1, G=3, H=2, F=1 = 14
    """
    if phase == 1:
        counts = {
            TYPE_A: 5,
    ...
    assignments = []
    for wtype in [TYPE_A, TYPE_B, TYPE_C, TYPE_D, TYPE_E, TYPE_G, TYPE_H, TYPE_F]:
